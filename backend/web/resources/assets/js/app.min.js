...
// removed by extract-text-webpack-plugin
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            (function ($) {
                ...
                $(document).on('click', '[data-toggle="mode"]', function () {
                    ...
                    setTimeout(function () {
                        $('.navigation .navigation-menu-body ul li a').each(function () {
                            ...
                            if ($this.next('ul').length) {
                                $this.append('<i class="sub-menu-arrow fa fa-angle-up"></i>');
                            }
                        });
                        ...
                        $('body.horizontal-navigation .horizontal-navigation ul li a').each(function () {
                            ...
                            if ($this.next('ul').length) {
                                $this.append('<i class="sub-menu-arrow fa fa-angle-right"></i>');
                            }
                        });
                    }, 200);
                });
                ...
                $(document).on('click', '[data-toggle="search"], [data-toggle="search"] *', function () {
                    $('#search-form').show().find('.form-control').focus();
                    return false;
                });
                ...
                $(document).on('click', '.navigation ul li a', function () {
                    ...
                    if ($this.next('ul').length) {
                        ...
                        $this.next('ul').find('li>a').find('.sub-menu-arrow').removeClass('fa fa-minus').addClass('ti-plus');
                        $this.next('ul').find('li>a').find('.sub-menu-arrow').removeClass('rotate-in');
                        $this.parent('li').siblings().not($this.parent('li').find('ul')).find('>a').find('.sub-menu-arrow').removeClass('fa fa-minus').addClass('fa fa-plus');
                        ...
                        if (sub_menu_arrow.hasClass('rotate-in')) {
                            setTimeout(function () {
                                sub_menu_arrow.removeClass('fa fa-plus').addClass('fa fa-minus');
                            }, 200);
                        } else {
                            sub_menu_arrow.removeClass('fa fa-minus').addClass('fa fa-plus');
                        }
