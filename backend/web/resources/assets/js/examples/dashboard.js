...
$(document).ready(function () {
    ...
    if (localStorage.getItem("mode") === "dark") {
        if (!$("body").hasClass("dark")) {
            ...
            $('[data-toggle="mode"]').addClass("active-mode");
        }
    }
    ...
    function chart_demo_1() {
        if ($('#chart_demo_1').length) {
            let element = document.getElementById("chart_demo_1");
            element.height = 146;
            new Chart(element, {
                type: 'bar',
                data: {
    ...
    function chart_demo_2() {
        if ($('#chart_demo_2').length) {
            let ctx = document.getElementById('chart_demo_2').getContext('2d');
            new Chart(ctx, {
                type: 'line',
                data: {
    ...
    function chart_demo_3() {
        if ($('#chart_demo_3').length) {
            let element = document.getElementById("chart_demo_3"),
    ...
    function chart_demo_4() {
        if ($('#chart_demo_4').length) {
            let ctx = document.getElementById("chart_demo_4").getContext("2d");
            let densityData = {
                backgroundColor: chartColors.primary.light,
    ...
    function chart_demo_5() {
        if ($('#chart_demo_5').length) {
            let ctx = document.getElementById('chart_demo_5').getContext('2d');
    ...
    function chart_demo_6() {
        if ($('#chart_demo_6').length) {
            let ctx = document.getElementById("chart_demo_6").getContext("2d");
            let speedData = {
    ...
    function chart_demo_7() {
        if ($('#chart_demo_7').length) {
            ...
            let ctx = document.getElementById('chart_demo_7').getContext('2d');
    ...
    function chart_demo_10() {
        if ($('#chart_demo_10').length) {
            let element = document.getElementById("chart_demo_10");
            new Chart(element, {
                type: 'bar',
                data: {
    ...
    function bar_chart() {
        if ($('#chart-ticket-status').length > 0) {
            ...
            let dataPack1 = [40, 47, 44, 38, 27, 40, 47, 44, 38, 27, 40, 27];
            let dataPack2 = [10, 12, 7, 5, 4, 10, 12, 7, 5, 4, 10, 12];
            let dataPack3 = [17, 11, 22, 18, 12, 17, 11, 22, 18, 12, 17, 11];
            let dates = ["Jan", "Jan", "Jan", "Apr", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"];

            let bar_ctx = document.getElementById('chart-ticket-status');
    ...
    function online_users() {
        if ($('#online-users').length > 0) {
            ...
            let chart = new ApexCharts(document.querySelector("#online-users"), options);
            chart.render();
    ...
    function analytics_tab1() {
        if ($('#analytics-tab-1').length) {
            ...
            let chart = new ApexCharts(document.querySelector("#analytics-tab-1"), options);
            chart.render();
        }
    }
    ...
    function analytics_tab2() {
        if ($('#analytics-tab-2').length) {
            ...
            let chart = new ApexCharts(document.querySelector("#analytics-tab-2"), options);
            chart.render();
        }
    }
    ...
    function analytics_tab3() {
        if ($('#analytics-tab-3').length) {
            ...
            let chart = new ApexCharts(document.querySelector("#analytics-tab-3"), options);
            chart.render();
        }
    }
    ...
    function analytics_tab4() {
        if ($('#analytics-tab-4').length) {
            ...
            let chart = new ApexCharts(document.querySelector("#analytics-tab-4"), options);
            chart.render();
        }
    }
    ...
    function widget_chart1() {
        if ($('#widget-chart1').length) {
            let ctx = document.getElementById("widget-chart1");
            ctx.height = 50;
    ...
    function widget_chart2() {
        if ($('#widget-chart2').length) {
            let ctx = document.getElementById("widget-chart2");
            ctx.height = 50;
            let barChart = new Chart(ctx.getContext('2d'), {
                type: 'line',
                data: {
                    labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sst", "Sun"],
                    datasets: [{
    ...
    function widget_chart3() {
        if ($('#widget-chart3').length) {
            let ctx = document.getElementById("widget-chart3");
            ctx.height = 50;
            let barChart = new Chart(ctx.getContext('2d'), {
                type: 'line',
                data: {
    ...
    function hotProducts() {
        if ($('#hot-products').length) {
            let options = {
                ...
                labels: ['Эркаклар', 'Аёллар', 'Вояга этмаганлар', '60 ёшдан катталар'],
                dataLabels: {
                    enabled: false,
            ...
            let chart = new ApexCharts(document.querySelector("#hot-products"), options);
            chart.render();
        }
    }
    ...
    function activityChart() {
        if ($('#ecommerce-activity-chart').length) {
            let options = {
                ...
                series: [{
                    name: 'Жавоб берилган мурожжатлар сони',
                    data: [44, 55, 57, 56, 61, 58, 63, 60, 66]
                }, {
                    name: 'Мурожжатлар сони',
                    data: [76, 85, 101, 98, 87, 105, 91, 114, 94]
                }],
                ...
                xaxis: {
                    categories: ['Январ', 'Феврал', 'Март', 'Апрел', 'Май', 'Инюь', 'Июль', 'Август', 'Сентябр'],
                },
                fill: {
                    opacity: 1
                },
